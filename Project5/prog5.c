...
created. The function excepts a file pointer to the dictionary, a file pointer
to the user dictionary, the array containing the text and the number of rows
in text. The file returns a file pointer of back which is the file pointer to
the user dictionary*/
FILE *spellCheck(FILE *Dictionary, FILE *userDictionary, int rowNum, char **text
                                                           ,int *userDictToggle)
  {
    ...
    for(i=0;i<rowNum;i++)
      ...
      //return the file pointer to the user dictionary
...
int main(int argc, char *argv[])
  {
    ...
    //Also intialize the user dicitonary to NULL
    FILE *inputFile, *dictionary, *outputFile, *userDictionary = NULL;
        ...
        switch(userMenuChoice)
          {
            ...
            userDictionary = spellCheck(dictionary,userDictionary,rows,text,
                                                          &userDictToggle);
